...
func TestSavepoint(t *testing.T) {
	...
	_,_,dd:=env.testHistoryDB.Commit(gb)
	testutil.AssertNoError(t,dd, "")
	...
	_,_,errq:= env.testHistoryDB.Commit(block1)
	testutil.AssertNoError(t, errq, "")
	savepoint, err = env.testHistoryDB.GetLastSavepoint()
	testutil.AssertNoError(t, err, "Error upon historyDatabase.GetLastSavepoint()")
...
func TestHistory(t *testing.T) {
	...
	_,_,oo:=env.testHistoryDB.Commit(gb)
	testutil.AssertNoError(t, oo, "")
	...
	_,_,err = env.testHistoryDB.Commit(block1)
	testutil.AssertNoError(t, err, "")
	...
	testutil.AssertNoError(t, err, "")
	_,_,err = env.testHistoryDB.Commit(block2)
	testutil.AssertNoError(t, err, "")
	...
	testutil.AssertNoError(t, err, "")
	_,_,err = env.testHistoryDB.Commit(block3)
	testutil.AssertNoError(t, err, "")
...
func TestHistoryForInvalidTran(t *testing.T) {
	...
	bg, gb := testutil.NewBlockGenerator(t, ledger1id, false)
	testutil.AssertNoError(t, store1.AddBlock(gb), "")
	_,_,fff:=env.testHistoryDB.Commit(gb)
	testutil.AssertNoError(t, fff, "")
...
func TestGenesisBlockNoError(t *testing.T) {
	...
	testutil.AssertNoError(t, err, "")
	_,_,err = env.testHistoryDB.Commit(block)
	testutil.AssertNoError(t, err, "")
}
